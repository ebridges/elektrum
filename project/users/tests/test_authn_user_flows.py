...
class AuthnUserFlowTest(TestCase):
    ...
    def test_signup_flow(self):
        ...
        response = c.post('/account/signup/',
                          {'username': 'newuser', 'email': 'newuser@example.com', 'first_name': 'first',
    ...
    def util_assert_account_redirects(self, response, expected_url='/account/confirm-email/', expected_redirect_sc=302,
